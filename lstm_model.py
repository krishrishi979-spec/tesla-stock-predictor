"""
Model 1: LSTM (Long Short-Term Memory) Neural Network
Best for: Capturing long-term temporal dependencies in stock data
"""
...
if __name__ == "__main__":
    print("LSTM Stock Predictor Module")
    print("This module provides LSTM neural network for stock prediction")
    print("\nUsage:")
    print("  from models.lstm_model import LSTMStockPredictor")
    print("  model = LSTMStockPredictor(sequence_length=60, n_features=50)")
